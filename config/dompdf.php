...
return [
    ...
    */
    ...
    // Otomatis deteksi folder public_html di server hosting atau folder public di lokal
    'public_path' => is_dir(base_path('../public_html')) ? base_path('../public_html') : base_path('public'),
    ...
    'options' => [
         ...
         * $dompdf = new DOMflow();  $dompdf->load_html($htmldata); $dompdf->render(); $pdfdata = $dompdf->output();
         */
