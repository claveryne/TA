...
<head>
    ...
    <link rel="icon" href="{{ asset_versioned('images/gambarLogo.png') }}" type="image/png">
    <link rel="apple-touch-icon" href="{{ asset_versioned('images/gambarLogo.png') }}">
    <!-- Bootstrap CSS -->
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset_versioned('images/logo Legacy warna 1.png') }}" alt="Logo" width="150">
            </a>
    ...
    <footer>
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <a href="#" class="footer-logo">
                        <img src="{{ asset_versioned('images/logo Legacy warna 1.png') }}" alt="Logo" width="250">
                    </a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul>
                        ...
                        <li><a href="mailto:[houseoflegacyjogja@gmail.com]"><i class="fa-solid fa-envelope me-2"></i> houseoflegacyjogja@gmail.com</li></a>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p class="mb-0">&copy; 2026 House of Legacy Jogja. All rights reserved.</p>
            </div>
        </div>
    </footer>
