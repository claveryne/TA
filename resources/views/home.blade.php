                ...
                <div class="room-card">
                    ...
                    <div class="room-details">
                        ...
                        <div class="d-flex align-items-center mb-3" style="color: var(--color-secondary);">
                            ...
                            <span class="mb-0" style="font-weight: 500; padding-right: 30px;">10-20 orang</span>
                            <i class="fa-solid fa-ruler-combined me-2"></i>
                            <span class="mb-0" style="font-weight: 500;">100 m²</span>
                        </div>
                        <div class="room-tags">
                    ...
                    <form action="{{ route('booking.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama_acara" class="modern-input" placeholder="Nama Instansi - Acara" required>
                            </div>
                            <div class="col-md-6">
