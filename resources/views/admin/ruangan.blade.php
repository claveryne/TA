...
<style>
    ...
    .table-ruangan th:first-child { border-top-left-radius: 10px; }
    .table-ruangan th:last-child { border-top-right-radius: 10px; text-align: center; }
...
<div class="data-card">
    <div class="table-toolbar">
        ...
        <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Cari ruangan..." value="{{ request('search') }}">
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->foto_ruangan)
                                <img src="{{ asset('uploads/ruangan/' . $item->foto_ruangan) }}" 
                        ...
                        <td>
                            <div class="action-btns">
                                <button class="btn-action btn-edit" 
                                    ...
                                    data-status="{{ $item->status_ruangan }}"
                                    data-ukuran="{{ $item->ukuran_ruangan }}"
                                    data-kapasitas="{{ $item->kapasitas_ruangan }}"
                                    data-jenis="{{ $item->jenis_ruangan }}"
                                    data-keterangan="{{ $item->keterangan_ruangan }}">
...
<div class="modal fade" id="modalTambahRuangan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
            ...
            <form action="{{ route('ruangan.store') }}" method="POST" id="formTambahRuangan" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4" style="background-color: #ffffff;">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-600">Nama<span style="color: red;">*</span></label>
                            <input type="text" name="nama_ruangan" class="form-control custom-input" placeholder="Masukkan nama ruangan" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="ukuran_ruangan" class="form-control custom-input" placeholder="Contoh: 400" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kapasitas_ruangan" class="form-control custom-input" placeholder="Contoh: 200-300" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-600">Jenis<span style="color: red;">*</span></label>
                            <input type="text" name="jenis_ruangan" class="form-control custom-input" placeholder="Contoh: Hall / Meeting Room" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-600">Keterangan</label>
                            <textarea name="keterangan_ruangan" class="form-control custom-input" rows="3" placeholder="Tambahkan deskripsi ruangan..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body p-4" style="background-color: #ffffff;">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="font-size: 13px; color:grey;">Jika status "Berakhir", data ruangan tidak akan tampil.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-600">Luas (m²)<span style="color: red;">*</span></label>
                            <input type="number" name="ukuran_ruangan" class="form-control custom-input" required>
                        </div>
                        <div class="col-md-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        modalEditRuangan.addEventListener('show.bs.modal', function (event) {
            ...
            modalEditRuangan.querySelector('select[name="status_ruangan"]').value = status;
