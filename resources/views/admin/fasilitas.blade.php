...
@push('styles')
    <style>
        ...
        .filter-select {
            width: 200px;
            /* Lebar tetap 200px sesuai keinginanmu */
            padding: 10px 40px 10px 15px;
            /* Padding kanan diperbesar (40px) agar teks tidak menabrak panah */
            border-radius: 10px;
        ...
        <div class="table-toolbar">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                <select id="filterJenis" class="filter-select">
                    ...
                    <option value="Sound System" {{ request('jenis') == 'Sound System' ? 'selected' : '' }}>Sound System
                    </option>
                            ...
                            <td>
                                <div class="action-btns">
                                    <button class="btn-action btn-edit" data-bs-toggle="modal"
                                        data-bs-target="#modalEditFasilitas" data-id="{{ $item->id_fasilitas }}"
                                        data-url="{{ route('fasilitas.update', $item->id_fasilitas) }}"
                                        data-nama="{{ $item->nama_fasilitas }}" data-status="{{ $item->status_fasilitas }}"
                                        data-merk="{{ $item->merk_fasilitas }}" data-jenis="{{ $item->jenis_fasilitas }}"
                                        ...
                                        data-pemeliharaan="{{ $activePemeliharaan }}" data-foto="{{ $item->foto_fasilitas }}">
                    ...
                    <div class="modal-body p-4" style="background-color: #ffffff;">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="merk_fasilitas" class="form-control custom-input"
                                    placeholder="Contoh: Yamaha" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="keterangan_fasilitas" class="form-control custom-input" rows="3"
                                    placeholder="Tambahkan deskripsi fasilitas..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body p-4" style="background-color: #ffffff;">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="font-size: 13px; color:grey;">Jika status "Berakhir", data fasilitas tidak akan
                                    tampil.</div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-600">Jumlah Unit<span style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-600">Foto <a href="javascript:void(0)"
                                        id="linkPreviewFotoFasilitas" class="text-secondary text-decoration-underline ms-2"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            modalEditFasilitas.addEventListener('show.bs.modal', function (event) {
                ...
                var selectStatus = modalEditFasilitas.querySelector('select[name="status_fasilitas"]');
                selectStatus.value = status;

                // Jika status fasilitas adalah Pemeliharaan, buat menjadi readonly
                ...
                var previewLink = modalEditFasilitas.querySelector('#linkPreviewFotoFasilitas');
