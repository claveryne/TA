...
<style>
    ...
    .table-pelanggan th:first-child { border-top-left-radius: 10px; }
    .table-pelanggan th:last-child { border-top-right-radius: 10px; text-align: center; }
...
<div class="data-card">
    <div class="table-toolbar">
        ...
        <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Cari pelanggan..." value="{{ request('search') }}">
        </div>
    </div>
                        ...
                        <td>
                            <div class="action-btns">
                                <button class="btn-action btn-edit" 
                                    ...
                                    data-id="{{ $item->id }}"
                                    data-url="{{ route('pelanggan.update', $item->id) }}"
                                    data-name="{{ $item->name }}"
...
<div class="modal fade" id="modalTambahPelanggan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
            ...
            <form action="{{ route('pelanggan.store') }}" method="POST" id="formTambahPelanggan" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4" style="background-color: #ffffff;">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-600">Nama<span style="color: red;">*</span></label>
                            <input type="text" name="name" class="form-control custom-input" placeholder="Masukkan nama pelanggan" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" class="form-control custom-input" rows="3" placeholder="Tambahkan alamat pelanggan..." required></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body p-4" style="background-color: #ffffff;">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="font-size: 13px; color:grey;">Jika role terisi, maka user menjadi Karyawan.</div>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-600">Alamat<span style="color: red;">*</span></label>
